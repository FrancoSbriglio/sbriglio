...
type EntityResponseType = HttpResponse<IColor>;
type EntityArrayResponseType = HttpResponse<IColor[]>;
...
export class ColorService {
  ...
  update(color: IColor): Observable<EntityResponseType> {
    return this.http.put<IColor>(this.resourceUrl, color, { observe: 'response' });
  }
