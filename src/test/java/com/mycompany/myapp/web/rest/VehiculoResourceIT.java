...
public class VehiculoResourceIT {
    ...
    public void setup() {
        ...
        final VehiculoResource vehiculoResource = new VehiculoResource(vehiculoRepository);
    ...
    public void createVehiculo() throws Exception {
        ...
        assertThat(testVehiculo.getDominio()).isEqualTo(DEFAULT_DOMINIO);
    }
    ...
    public void updateVehiculo() throws Exception {
        ...
        Vehiculo testVehiculo = vehiculoList.get(vehiculoList.size() - 1);
        assertThat(testVehiculo.getDominio()).isEqualTo(UPDATED_DOMINIO);
    }
