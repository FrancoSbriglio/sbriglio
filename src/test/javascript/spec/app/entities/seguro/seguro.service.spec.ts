...
describe('Service Tests', () => {
  describe('Seguro Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(SeguroService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Seguro(0, currentDate);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            fechaVencimientoSeguro: currentDate.format(DATE_TIME_FORMAT)
          },
          elemDefault
        );
        service
      ...
      it('should create a Seguro', () => {
        ...
        const expected = Object.assign(
          {
            fechaVencimientoSeguro: currentDate
          },
          returnedFromService
        );
        service
          .create(new Seguro(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
